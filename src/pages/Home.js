    ...
    <div>
      <header class="header clearfix">
        ...
        <div class="main_logo" id="logo">
          ...
          <a href="index.html">
            <img class="logo-inverse" src="images/ct_logo.svg" alt="" />
          </a>
        </div>
          ...
          <ul>
            ...
            <li class="ui dropdown">
              ...
              <div class="menu dropdown_account">
                ...
                <a href="help.html" class="item channel_item">
                  Help
                </a>
                <a href="feedback.html" class="item channel_item">
                  Send Feedback
                </a>
                <a href="sign_in.html" class="item channel_item">
                  Sign Out
                </a>
              </div>
            </li>
            ...
            <ul>
              ...
              <li class="menu--item menu--item__has_sub_menu">
                ...
                <ul class="sub_menu">
                  ...
                  <li class="sub_menu--item">
                    <a href="#.html" class="sub_menu--link">
                      IT & Software
                    </a>
                  </li>
                  <li class="sub_menu--item">
              ...
              <li class="menu--item  menu--item__has_sub_menu">
                ...
                <ul class="sub_menu">
                  <li class="sub_menu--item">
                    <a href="certification_center.html" class="sub_menu--link">
              ...
              <li class="menu--item  menu--item__has_sub_menu">
                ...
                <ul class="sub_menu">
                  <li class="sub_menu--item">
                    <a href="about_us.html" class="sub_menu--link">
                      About
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="sign_in.html" class="sub_menu--link">
                      Sign In
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="sign_up.html" class="sub_menu--link">
                      Sign Up
                    </a>
                  </li>
                  <li class="sub_menu--item">
                  ...
                  <li class="sub_menu--item">
                    <a href="membership.html" class="sub_menu--link">
                      Paid Membership
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="course_detail_view.html" class="sub_menu--link">
                      Course Detail View
                    </a>
                  </li>
                  <li class="sub_menu--item">
                  ...
                  <li class="sub_menu--item">
                    <a href="invoice.html" class="sub_menu--link">
                      Invoice
                    </a>
                  </li>
                  <li class="sub_menu--item">
                  ...
                  <li class="sub_menu--item">
                    <a href="apply_job.html" class="sub_menu--link">
                      Job Apply
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="our_blog.html" class="sub_menu--link">
                      Our Blog
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="blog_single_view.html" class="sub_menu--link">
                      Blog Detail View
                    </a>
                  </li>
                  <li class="sub_menu--item">
                  ...
                  <li class="sub_menu--item">
                    <a href="press.html" class="sub_menu--link">
                      Press
                    </a>
                  </li>
                  <li class="sub_menu--item">
                  ...
                  <li class="sub_menu--item">
                    <a href="thank_you.html" class="sub_menu--link">
                      Thank You
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="coming_soon.html" class="sub_menu--link">
                      Coming Soon
                    </a>
                  </li>
                  <li class="sub_menu--item">
                    <a href="error_404.html" class="sub_menu--link">
                      Error 404
                    </a>
                  </li>
                </ul>
            ...
            <div class="row">
              <div class="col-xl-9 col-lg-8">
                <div class="section3125">
                  ...
                  <a href="live_streams.html" class="see150">
                    See all
                  </a>
                  <div class="la5lo1">
                        ...
                        <div class="fcrse_1 mb-20">
                          <a href="course_detail_view.html" class="fcrse_img">
                            ...
                            <div class="course-overlay">
                              ...
                              <div class="crse_timer">12 hours</div>
                            </div>
                          </a>
                          <div class="fcrse_content">
                            <div class="eps_dots more_dropdown">
                        ...
                        <div class="fcrse_1 mb-20">
                          <a href="course_detail_view.html" class="fcrse_img">
                            ...
                            <div class="course-overlay">
                              ...
                              <div class="crse_timer">1.5 hours</div>
                            </div>
                          </a>
                          <div class="fcrse_content">
                            <div class="eps_dots more_dropdown">
                        ...
                        <div class="fcrse_1 mb-20">
                          <a href="course_detail_view.html" class="fcrse_img">
                            ...
                            <div class="course-overlay">
                              ...
                              <div class="crse_timer">36 hours</div>
                            </div>
                          </a>
                          <div class="fcrse_content">
                            <div class="eps_dots more_dropdown">
                        ...
                        <div class="fcrse_1 mb-20">
                          <a href="course_detail_view.html" class="fcrse_img">
                            ...
                            <div class="course-overlay">
                              ...
                              <div class="crse_timer">15 hours</div>
                            </div>
                          </a>
                          <div class="fcrse_content">
                            <div class="eps_dots more_dropdown">
                ...
                <div class="section3125 mt-50">
                  ...
                  <a href="all_instructor.html" class="see150">
                    See all
                  </a>
                  <div class="la5lo1">
                    ...
                    <ul class="allcate15">
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-arrow"></i>Development
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-graph-bar"></i>Business
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-monitor"></i>IT and Software
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-ruler"></i>Design
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-chart-line"></i>Marketing
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-book-open"></i>Personal Development
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                          <i class="uil uil-camera"></i>Photography
                        </a>
                      </li>
                      <li>
                        <a href="#" class="ct_item">
                        ...
                        <div class="fcrse_4 mb-20">
                          <div class="say_content">
                            <p>
                              ...
                              id, sagittis vitae est. Pellentesque vitae laoreet
                              tortor."
                            </p>
                          </div>
                          <div class="st_group">
        ...
        <footer class="footer mt-30">
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-3 col-md-3 col-sm-6">
                <div class="item_f3">
                  <a href="#" class="btn1542">
                    Teach on Cursus
                  </a>
                  <div class="lng_btn">
                    <div
                      class="ui language bottom right pointing dropdown floating"
                      id="languages"
                      data-content="Select Language">
                      <a href="#">
                        <i class="uil uil-globe lft"></i>Language
                        <i class="uil uil-angle-down rgt"></i>
                      </a>
                      <div class="menu">
